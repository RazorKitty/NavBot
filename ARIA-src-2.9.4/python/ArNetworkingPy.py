...
class ArServerModeWander(ArServerMode):
    ...
    def __init__(self, server, robot, forwardVel=400, avoidFrontDist=450, avoidVel=200, turnAmt=15):
        """
        __init__(ArServerModeWander self, ArServerBase server, ArRobot robot, int forwardVel=400, int avoidFrontDist=450, int avoidVel=200, int turnAmt=15) -> ArServerModeWander
        __init__(ArServerModeWander self, ArServerBase server, ArRobot robot, int forwardVel=400, int avoidFrontDist=450, int avoidVel=200) -> ArServerModeWander
        __init__(ArServerModeWander self, ArServerBase server, ArRobot robot, int forwardVel=400, int avoidFrontDist=450) -> ArServerModeWander
        __init__(ArServerModeWander self, ArServerBase server, ArRobot robot, int forwardVel=400) -> ArServerModeWander
        __init__(ArServerModeWander self, ArServerBase server, ArRobot robot) -> ArServerModeWander
        """
        this = _ArNetworkingPy.new_ArServerModeWander(server, robot, forwardVel, avoidFrontDist, avoidVel, turnAmt)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
